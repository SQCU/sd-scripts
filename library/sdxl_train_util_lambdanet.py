...
from library import model_util, sdxl_model_util_lambdanet, train_util, sdxl_original_unet_skiplambda
...
def _load_target_model(
    ...
    if load_stable_diffusion_format:
        ...
        state_dict = sdxl_model_util_lambdanet.convert_diffusers_unet_state_dict_to_sdxl(unet.state_dict())
        with init_empty_weights():
            unet = sdxl_original_unet_skiplambda.SdxlUNet2DConditionModel(**initdict)  # overwrite unet
            #aaaaaaaaaAAAAAA HATE PYTHONERS HATE PYTHONERS HATE PYTHONERS
        sdxl_model_util_lambdanet._load_state_dict_on_device(unet, state_dict, device=device, dtype=model_dtype)
...
def save_sd_model_on_train_end(
    ...
    def sd_saver(ckpt_file, epoch_no, global_step):
        ...
        sdxl_model_util_lambdanet.save_stable_diffusion_checkpoint(
            ckpt_file,
            text_encoder1,
            text_encoder2,
            unet,
    ...
    def diffusers_saver(out_dir):
        sdxl_model_util_lambdanet.save_diffusers_checkpoint(
            out_dir,
            text_encoder1,
            text_encoder2,
            unet,
