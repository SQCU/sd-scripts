...
accelerate launch --num_cpu_threads_per_process 8 sdxl_train_network.py ^
	...
	--dataset_config="F:/dox/ai/training-data/inbound/train_class/small_bundled_class/smallblora_mid_iii.toml" ^
	...
	--learning_rate=5e-05 ^
	--seed=0 ^
	--optimizer_args weight_decay=2e-03 betas=(0.9,0.999)
